...
export function FeaturesGrid({ features, className = "" }: FeaturesGridProps) {
  return (
    ...
    >
      <SectionTitle
        title="Everything your business needs to sell smarter"
        description="ainnect combines a full-featured CRM with AI that does the busywork — so your team can focus on closing deals."
      />
      <div
        className={cn(
