...
import banner from "../../client/static/banner.png";
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-8">
          <div className="lg:mb-18 mx-auto max-w-3xl text-center">
            <h1 className="text-foreground text-5xl font-bold sm:text-6xl">
              The <span className="text-gradient-primary">AI-powered CRM</span>{" "}
              that grows your <span className="italic">business</span>
            </h1>
            <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-lg leading-8">
              ainnect captures your leads, manages every customer relationship,
              and lets AI handle the follow-ups — so your team can focus on
              closing more deals.
            </p>
          ...
          <div className="mt-14 flow-root sm:mt-14">
            <div className="m-2 hidden justify-center rounded-xl md:flex lg:-m-4 lg:rounded-2xl lg:p-4">
              <img
                src={banner.src}
                alt="ainnect — the AI-powered CRM for business"
                width={1000}
                height={530}
                loading="lazy"
