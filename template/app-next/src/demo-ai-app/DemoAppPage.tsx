      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-foreground mt-2 text-4xl font-bold tracking-tight sm:text-5xl">
            <span className="text-primary">ainnect</span> AI Assistant
          </h2>
        </div>
        <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-center text-lg leading-8">
          Add your team's tasks for the day and let ainnect's AI build a
          prioritized plan — the same engine that drafts follow-ups and
          suggests the next best action across your CRM.
        </p>
    ...
    taskItems: [
      {
        ...
        time: 0.5,
        taskName: "Prepare sales proposal",
      },
      {
        description: "Add case studies and testimonials",
        time: 0.3,
        taskName: "Prepare sales proposal",
      },
      {
        description: "Review and send to the client",
        time: 0.2,
        taskName: "Prepare sales proposal",
      },
      {
        ...
        time: 1,
        taskName: "Respond to customer emails",
      },
      {
      ...
      {
        description: "Call back the top 5 scored leads",
        time: 0.5,
        taskName: "Follow up with leads",
      },
      {
        description: "Send AI-drafted follow-up emails",
        time: 1.5,
        taskName: "Follow up with leads",
      },
      {
        description: "Update deal stages in the pipeline",
        time: 1,
        taskName: "Follow up with leads",
      },
    ],
