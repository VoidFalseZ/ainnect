...
const bestDealPaymentPlanId: PaymentPlanId = PaymentPlanId.ProPlus;
...
export const paymentPlanCards: Record<PaymentPlanId, PaymentPlanCard> = {
  [PaymentPlanId.Pro]: {
    ...
    price: "$20",
    description: "For small teams getting started with an AI CRM",
    features: [
  ...
  [PaymentPlanId.ProPlus]: {
    name: prettyPaymentPlanName(PaymentPlanId.ProPlus),
    price: "$60",
    description: "For growing sales teams that want more automation",
    features: [
      "Up to 15 team members",
      "Everything in Pro",
      "Workflow automation",
      "AI assistant & email sync",
      "Priority support",
    ],
  },
  [PaymentPlanId.Max]: {
    name: prettyPaymentPlanName(PaymentPlanId.Max),
    price: "$200",
    description: "For businesses that need it all, at scale",
    features: [
    ...
    <div className="py-10 lg:mt-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-center text-lg leading-8">
          Simple, transparent pricing for businesses of every size. Start free
          and upgrade as your team grows — every plan includes ainnect's AI
          assistant, sales pipeline, and contact management.
        </p>
        {errorMessage && (
